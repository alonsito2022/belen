...
function DailyEntryListAddRow({filterObj, fort, fetchDailyEntries, suppliers}:any) {
        ...
        <section className="dark:bg-gray-900 bg-sky-400 my-4 border border-gray-300">
            ...
            <h2 className="mb-3 text-xl font-medium text-white dark:text-white">Añadir nuevo registro diario</h2>
                ...
                <button type="button" onClick={handleClickButtonAdd}
                    className="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800" >Nuevo Registro</button>
...
export default DailyEntryListAddRow