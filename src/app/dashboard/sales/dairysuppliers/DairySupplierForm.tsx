...
import { IChoice, IPerson, IProductTariff, ISupplierTariff } from '@/app/types';
...
function DairySupplierForm({modal, setModal, setSupplier, supplier, fetchSuppliers, filterObj, districts}: any) {
            ...
            queryFetch = `
                mutation{
                    createSupplier(
                        ...
                        isEnabled:${supplier.isEnabled}, typeOfDairyProduct:"03", fortnightValue:${0}, weekValue:${0}
                    ){
                        message
                    }
                }
...
export default DairySupplierForm