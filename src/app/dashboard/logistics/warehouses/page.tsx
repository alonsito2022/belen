...
function WarehousePage() {
    ...
    return (
        <>
        <h2 className="text-4xl font-bold dark:text-white pb-4">Almacenes</h2>
            ...
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        ...
                        {warehouses.map((item) => 
                            <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="px-6 py-4">{item.categoryReadable}</td>
                                <td className="px-6 py-4">{item.subsidiaryName}</td>
                    ...
                    <form onSubmit={handleSaveWarehouse}>
                        ...
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value={warehouse.name} onChange={handleInputChange} onFocus={(e) => e.target.select()} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type almacen name" required />
                            </div>

                            <div className="sm:col-span-2">
                                <label htmlFor="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Categoria</label>
                                <select name="category" id="category" onChange={handleInputChange} value={warehouse.category.replace("A_", "")} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    {options.map((o,k)=>(
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <select name="subsidiaryId" id="subsidiaryId" onChange={handleInputChange} value={warehouse.subsidiaryId} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
