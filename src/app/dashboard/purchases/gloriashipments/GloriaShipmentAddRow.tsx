...
function GloriaShipmentAddRow({filterObj, fort, getGloriaShipments, suppliers}:any) {
    ...
    return (
        ...
        <section className="dark:bg-gray-900 bg-lime-500 my-4 border border-gray-300">
            <div className="py-4 px-4 ">
                <h2 className="mb-3 text-xl font-medium text-white dark:text-white">Añadir nuevo envio gloria</h2>

                <div className='grid gap-4 sm:grid-cols-4 sm:gap-6'>

                    <div className="relative " onClick={(event)=>event.nativeEvent.stopImmediatePropagation()}>
                        <input type="hidden" id="autocompleteInputSupplierId" />
                        
                        <label htmlFor="autocompleteInputSupplierName" className="block mb-1 text-sm font-normal text-white dark:text-white">Proveedor</label>
                    ...
                    <div className="w-full">
                        <label htmlFor="quantityTomorrow" className="block mb-1 text-sm font-normal text-white dark:text-white">
                    ...
                    <div className="w-full">
                        <label htmlFor="quantityAfternoon" className="block mb-1 text-sm font-normal text-white dark:text-white">
                    ...
                    <div className="flex items-end">
                        <button type="button" onClick={handleClickButtonAdd} className="border border-gray-500 px-5 py-3.5 text-sm text-center  bg-gray-800 text-white rounded-lg focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-900 hover:bg-gray-800" >Nuevo Registro</button>
